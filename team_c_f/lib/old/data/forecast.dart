...
class Forecast {
  ...
  late String _docId; // Идентификатор документа с прогнозом
  final String
  ...
  late int _points; // Количество набранных очков
  final String team;
  ...
  factory Forecast.fromJson({required Map<String, dynamic> json, required String docId}) {
